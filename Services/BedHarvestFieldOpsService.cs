...
public class BedHarvestFieldOpsService : IBedHarvestFieldOpsService
{
    ...
    public BedHarvestFieldOpsService(ILogger logger, string cosmosDbDatabase, string cosmosDbContainer, ICosmosDbService cosmosDbService, IHarvestService harvestService, IBedService bedService)
    {
