...
public class FedExPostalController : ControllerBase
{
    ...
    public IQueryResult GetFedExInfo()
    {
        ...
        var data = new List<BedHarvestFieldOpsViewModel> { new() { BedNumber = resp.Content } };

        return new QueryResult<List<BedHarvestFieldOpsViewModel>> { Data = data, Status = new SuccessResult() };
    }
